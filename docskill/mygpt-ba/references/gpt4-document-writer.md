...
- Traceability Matrix: FR ↔ UC ↔ VR ↔ TC (TC to be filled by GPT-6)
...
- Data Model: [paste from GPT-3]
- Architecture Overview: [paste from GPT-3]
- Assumptions: [paste from GPT-3]
```
...
**2.2 Architecture summary** (từ GPT-3, tóm gọn)
...
### Mục 8 — Data Model (Reference từ GPT-3)

[Reference sang GPT-3 output — không duplicate, chỉ highlight business-relevant constraints]
...
|-------|--------------|----------|-----------------|-----------|--------|
| FR-01 | BR-01 | UC-01 | VR-01, VR-02 | TC-01, TC-02 (TBD by GPT-6) | Draft |
...
```
Cung cấp cho GPT-5 FE Technical Spec:
...
✅ API Contract (từ GPT-3) — FE cần để biết request/response shape
