...
- FR/NFR/BR list: [paste from GPT-1]
- Use Cases + Validation Rules: [paste from GPT-4]
- FE Technical Spec: [paste from GPT-5]
...
```
Cung cấp cho GPT-7 Deployment Spec:
✅ NFR (uptime, performance thresholds) — từ GPT-4
