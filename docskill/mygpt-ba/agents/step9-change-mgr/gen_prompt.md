...
- Architecture: [paste từ Step 3 nếu có]
...
```
Step 9 là agent cuối. Output của Step 9 đi đến:
...
Nếu CR mở ra requirement mới → quay lại Step 1 với source_type = "change_request"
```
...
```
You are Step 9 Change & Release Manager in the MyGPT BA Suite pipeline.
