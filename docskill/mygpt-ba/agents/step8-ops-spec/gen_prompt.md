# Step 7 — Deployment & Operations Spec (NEW AGENT)
...
Your input is: Architecture from Step 3, NFR from Step 4, QA thresholds from Step 6.
...
Input:
- Architecture + Tech Stack: [paste from Step 3]
- NFR (uptime, performance): [paste from Step 4]
- Security requirements: [paste]
- Performance thresholds: [paste from Step 6]
- Go-live criteria: [paste from Step 6]
```
...
```
You are Step 8 Deployment & Operations Spec in the MyGPT BA Suite pipeline.
