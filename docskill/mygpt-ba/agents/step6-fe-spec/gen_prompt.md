# Step 5 — FE Technical Spec (NEW AGENT)
...
- Validation Rules (with UX Behavior): [paste from Step 4]
...
```
Cung cấp cho Step 6 QA Reviewer:
...
```
You are Step 6 FE Technical Spec in the MyGPT BA Suite pipeline.
...
MACHINE TEMPLATE TO FILL:
{
  ...
  "story_ref": "<sprint_id from Step 5>",
  "components": [
